                    ...
                    items: [
                        {
                            ...
                            items: [
                                {
                                    label: 'Submenu 1.1', icon: 'pi pi-fw pi-bars',
                                    items: [
                                        {label: 'Submenu 1.1.1', icon: 'pi pi-fw pi-bars'},
                                        {label: 'Submenu 1.1.2', icon: 'pi pi-fw pi-bars'},
                                        {label: 'Submenu 1.1.3', icon: 'pi pi-fw pi-bars'},
                                    ]
                                },
                                {
                                    label: 'Submenu 1.2', icon: 'pi pi-fw pi-bars',
                                    items: [
                                        {label: 'Submenu 1.2.1', icon: 'pi pi-fw pi-bars'},
                                        {label: 'Submenu 1.2.2', icon: 'pi pi-fw pi-bars'}
                                    ]
                                },
                            ]
                        },
                        {
                            label: 'Página em Branco', icon: 'pi pi-fw pi-bars', to:'/empty'
